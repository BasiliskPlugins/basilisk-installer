package org.basilisk.utilities;
import org.basilisk.LoadingWindow;
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                while ((bytesRead = in.read(buffer)) != -1) {
                    ...
                    loadingWindow.setStatusText("Downloading Basilisk Plugin: " + (totalBytesRead * 100) / contentLength + "%");
